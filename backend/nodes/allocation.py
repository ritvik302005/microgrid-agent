...
llm = ChatGroq(
    ...
    model="openai/gpt-oss-20b",  # llama-3.1-8b-instant was deprecated/shut down by Groq
                                    # (Aug 16, 2026); gpt-oss-20b is Groq's recommended
                                    # replacement, and still much faster than the 120B model —
